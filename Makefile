...
dependencies-samples: texlive-update
	tlmgr install koma-script latex ly1 etoolbox hyperref xcolor babel oberdiek tools geometry libertine eulervm sourcecodepro microtype csquotes relsize totpages amsmath amscls amsfonts tools cancel pgf algorithm2e listings listingsutf8 graphics float caption pgfplots
